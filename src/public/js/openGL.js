...
function createGlContext()
{
    ...
    $.when( $.ajax({url:directory + "/shaders/draw.vert", dataType: "text"}),
            $.ajax({url:directory + "/shaders/screen.vert", dataType: "text"}),
            $.ajax({url:directory + "/shaders/screen.frag", dataType: "text"}),
            $.ajax({url:directory + "/shaders/header.frag", dataType: "text"})).done( function(d, v, f, h){
    ...
    testImage.src = directory + "/images/test.jpg";
}
...
{
    var n = (mHeader + mInputsStr + mOSCStr).split(/\r\n|\r|\n/).length;
    return n;
}
